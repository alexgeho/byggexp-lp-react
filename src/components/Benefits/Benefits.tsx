  ...
  return (
    <section className="benefits">
      <div className="container benefits-inner">
        ...
        <p className="solution-lead">{benefitsT.office.benefitsOfficeLead}</p>
      ...
      <div className="benefits-team">
        <div className="container benefits-inner">
          <p className="solution-lead-team">{benefitsT.site.benefitsSiteLead}</p>
          <div className="benefits-grid">
