export const featuresTranslations1_3 = {
  ru: {
    ...
    featuresCard1Text:
      "Сотрудник выбирает проект. ByggExp автоматически фиксирует рабочее время и определяя по GPS.",

    featuresCard1Step1: "Создай проект с адресом",
    featuresCard1Step2: "GPS сам запускает смену",
    featuresCard1Step3: "Часы сразу есть в системе",

    featuresCard2Title: "Задачи с авто контролем",
    featuresCard2Text:
      "Задача ставится всем на проекте или одному исполнителю. Если задача не выполнена — будут отправляться напоминания.",

    featuresCard2Step1:
      "Создайте задачу со сроками",
    featuresCard2Step2:
      "Добавьте интервал напоминаний",
    featuresCard2Step3:
      "Забыть о задаче не получится",

    featuresCard3Title: "Бригады в Live режиме",
    featuresCard3Text:
      "Контроль сотрудников в реальном времени. Все сразу видно: кто начал смену, кто отсутствует и где.",
  ...
  sv: {
    ...
    featuresCard2Text:
      "Uppgifter kan tilldelas hela projektet, utvalda medarbetare. Om uppgiften inte slutförs skickar appen påminnelser.",
