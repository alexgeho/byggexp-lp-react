export const featuresTranslations1_3 = {
  ru: {
    ...
    featuresSub:
      "Можно без ноутбука. Нужен только смартфон, который и так лежит в кармане.",
    ...
    featuresCard2Text:
      "Задача ставится всем на проекте, выбранным или одному исполнителю. Пока задача не выполнена — будут отправляться напоминания.",
